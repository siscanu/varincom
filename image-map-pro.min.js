...
!function ($, window, document, undefined) {
        ...
        if (e) {
            ...
            if (s) {
                ...
                if (e.connectedShapes[n.id])for (var h = 0; h < e.connectedShapes[n.id].length; h++) {
                    var r = e.connectedShapes[n.id][h].index, p = e.apiHighlightedShapes.indexOf(r);
    ...
    $(document).ready(function () {
        $(document).on("mouseover", "[data-imp-highlight-shape-on-mouseover]", function () {
            var t = $(this).data("imp-highlight-shape-on-mouseover"), i = findImageMapWithName($(this).data("imp-image-map-name"));
            if (i) {
            ...
            var t = $(this).data("imp-highlight-shape-on-click"), i = findImageMapWithName($(this).data("imp-image-map-name"));
            if (i) {
                var e = findShapeWithTitle(i.settings.general.name, t);
                if (e) {
            ...
            var t = $(this).data("imp-unhighlight-shape-on-mouseover"), i = findImageMapWithName($(this).data("imp-image-map-name"));
            if (i) {
                var e = findShapeWithTitle(i.settings.general.name, t);
                if (e) {
                    var s = e.shape, n = e.index;
            ...
            var t = $(this).data("imp-unhighlight-shape-on-click"), i = findImageMapWithName($(this).data("imp-image-map-name"));
            if (i) {
                var e = findShapeWithTitle(i.settings.general.name, t);
                if (e) {
                    var s = e.shape, n = e.index;
            ...
            var t = $(this).data("imp-open-tooltip-on-mouseover"), i = findImageMapWithName($(this).data("imp-image-map-name"));
            if (i) {
                var e = findShapeWithTitle(i.settings.general.name, t);
                if (e) {
                    var s = e.shape, n = e.index;
            ...
            var t = $(this).data("imp-open-tooltip-on-click"), i = findImageMapWithName($(this).data("imp-image-map-name"));
            if (i) {
                var e = findShapeWithTitle(i.settings.general.name, t);
                if (e) {
                    var s = e.shape, n = e.index;
            ...
            var t = $(this).data("imp-close-tooltip-on-mouseover"), i = findImageMapWithName($(this).data("imp-image-map-name"));
            if (i) {
                var e = findShapeWithTitle(i.settings.general.name, t);
                if (e) {
                    var s = e.shape, n = e.index;
            ...
            var t = $(this).data("imp-close-tooltip-on-click"), i = findImageMapWithName($(this).data("imp-image-map-name"));
            if (i) {
                var e = findShapeWithTitle(i.settings.general.name, t);
                if (e) {
                    var s = e.shape, n = e.index;
            ...
            var t = $(this).data("imp-trigger-shape-on-mouseover"), i = findImageMapWithName($(this).data("imp-image-map-name"));
            if (i) {
                var e = findShapeWithTitle(i.settings.general.name, t);
                if (e) {
                    var s = e.shape, n = e.index;
            ...
            var t = $(this).data("imp-trigger-shape-on-click"), i = findImageMapWithName($(this).data("imp-image-map-name"));
            if (i) {
                var e = findShapeWithTitle(i.settings.general.name, t);
                if (e) {
                    var s = e.shape, n = e.index;
            ...
            var t = $(this).data("imp-untrigger-shape-on-mouseover"), i = findImageMapWithName($(this).data("imp-image-map-name"));
            if (i) {
                var e = findShapeWithTitle(i.settings.general.name, t);
                if (e) {
                    var s = e.shape, n = e.index;
            ...
            var t = $(this).data("imp-untrigger-shape-on-click"), i = findImageMapWithName($(this).data("imp-image-map-name"));
            if (i) {
                var e = findShapeWithTitle(i.settings.general.name, t);
                if (e) {
                    var s = e.shape, n = e.index;
            ...
            var t = $(this).data("imp-focus-shape-on-mouseover"), i = findImageMapWithName($(this).data("imp-image-map-name"));
            if (i) {
                var e = findShapeWithTitle(i.settings.general.name, t);
                if (e) {
                    var s = e.shape, n = e.index;
            ...
            var t = $(this).data("imp-focus-shape-on-click"), i = findImageMapWithName($(this).data("imp-image-map-name"));
            if (i) {
                var e = findShapeWithTitle(i.settings.general.name, t);
                if (e) {
                    var s = e.shape, n = e.index;
    ...
    var pluginName = "imageMapPro", default_settings = $.imageMapProEditorDefaults, default_spot_settings = $.imageMapProShapeDefaults, instances = new Array;
    ...
    $.extend(Plugin.prototype, {
        init: function (t) {
            ...
            for (var t = 0; t < this.settings.spots.length; t++) {
                if ((y = this.settings.spots[t]).x = parseFloat(y.x), y.y = parseFloat(y.y), y.width = parseFloat(y.width), y.height = parseFloat(y.height), y.default_style.stroke_width = parseInt(y.default_style.stroke_width), y.mouseover_style.stroke_width = parseInt(y.mouseover_style.stroke_width), "poly" === y.type)for (var i = 0; i < y.points.length; i++)y.points[i].x = parseFloat(y.points[i].x), y.points[i].y = parseFloat(y.points[i].y)
            }
            ...
            for (t = 0; t < this.settings.spots.length; t++)if (!isTrue(this.settings.layers.enable_layers) || parseInt(this.settings.spots[t].layerID, 10) === parseInt(this.settings.runtime.layerID)) {
                var o = "";
                if (isTrue((y = this.settings.spots[t]).static) && (o = "imp-shape-static"), "spot" === y.type)if (isTrue(y.default_style.use_icon)) {
                ...
                if ("poly" === y.type) {
                    ...
                    var u = s * (y.width / 100), c = n * (y.height / 100);
                    y.vs = new Array;
                    for (i = 0; i < y.points.length; i++) {
                        var m = s * (y.x / 100) + y.points[i].x / 100 * u, f = n * (y.y / 100) + y.points[i].y / 100 * c;
                        a += m + "," + f + " ", y.vs.push([m, f])
                    }
                    a += '"></polygon>'
                }
            ...
            if ("always" === this.settings.tooltips.fullscreen_tooltips || "mobile-only" === this.settings.tooltips.fullscreen_tooltips && isMobile()) {
                ...
                for (var t = "", i = 0; i < this.settings.spots.length; i++) {
                    if ("text" !== (n = this.settings.spots[i]).type) {
                        var e = "", s = hexToRgb(n.tooltip_style.background_color) || {r: 0, b: 0, g: 0};
            ...
            if (isTrue(this.settings.layers.enable_layers)) {
                ...
                t || (this.settings.runtime.layerID = this.settings.layers.layers_list[0].id), this.wrap.find(".imp-ui-layers-select input:checked").val(this.settings.runtime.layerID)
            }
        }, initZoom: function () {
            ...
            if (isTrue(this.settings.zooming.enable_zooming) && isTrue(this.settings.zooming.enable_navigator))if (isTrue(this.settings.runtime.is_fullscreen)) {
                ...
                var t = this.settings.general.naturalWidth / this.settings.general.naturalHeight, i = window.innerWidth / window.innerHeight, e = 0, s = 0;
            ...
            setTimeout(function () {
                if ("fade" === e.settings.shapes.pageload_animation && s.css({opacity: t.default_style.opacity}), "grow" === e.settings.shapes.pageload_animation && s.css({
                    ...
                    s.css({"transition-property": "opacity"}), function i() {
            ...
            $(document).off("mousedown." + this.settings.id), $(document).on("mousedown." + this.settings.id, function (t) {
                ...
                s.hideAllTooltips()
            }), $(document).off("change." + this.settings.id, ".imp-ui-layers-select input:checked"), $(document).on("change." + this.settings.id, ".imp-ui-layers-select input:checked", function () {
                var t = s.wrap.find(".imp-ui-layers-select input:checked").val();
                s.switchLayer(t)
                ...
                if (s.resetZoomAndPan(), s.adjustNavigatorSize(), isTrue(s.settings.shapes_menu.enable_shapes_menu)) {
                    var i = s.responsiveShapesMenu, e = s.root.width();
                    ...
                    if ((e.x < this.wrapOffsetLeft || e.x > this.wrapOffsetLeft + this.wrapWidth || e.y < this.wrapOffsetTop || e.y > this.wrapOffsetTop + this.wrapHeight) && (n = !0), s || !n) {
                        if (isTrue(this.settings.zooming.enable_zooming)) {
                            if (this.panningOnNavigator) {
                                var a = (e.x - this.uiNavigatorRoot.offset().left) / this.navigatorRatio * this.targetZoom, o = (e.y - this.uiNavigatorRoot.offset().top) / this.navigatorRatio * this.targetZoom;
                                this.panTo(a, o)
                            }
            ...
            if (!this.isEventOnHTMLAPIElement(t)) {
                if (isTrue(this.settings.zooming.enable_zooming)) {
                    ...
                    if (this.panningOnNavigator && 0 < $(t.target).closest(".imp-ui-navigator-root").length && parseInt($(t.target).closest(".imp-ui-navigator-root").data("imp-id")) === parseInt(this.settings.id)) {
                        ...
                        var i = ((o = this.getEventCoordinates(t)).x - this.uiNavigatorRoot.offset().left) / this.navigatorRatio * this.targetZoom, e = (o.y - this.uiNavigatorRoot.offset().top) / this.navigatorRatio * this.targetZoom;
                ...
                if ($(t.target).hasClass("imp-clear-search") && $(t.target).data("image-map-pro-id") === parseInt(this.settings.id) && ($('input[data-image-map-pro-search-id="' + this.settings.id + '"]').val(""), this.updateMenuSearch()), 0 == $(t.target).closest(".imp-tooltip").length && !this.fullscreenTooltipVisible) {
                    if (1 === $(t.target).closest(".imp-ui").length)return this.unhighlightAllShapes(), void("mouseover" === this.settings.tooltips.show_tooltips && this.hideAllTooltips());
                    var a = this.getEventRelativeCoordinates(t), o = (s = this.matchShapeToCoords(a), this.getEventCoordinates(t));
            ...
            for (var i = this.settings.spots.length - 1; 0 <= i; i--)if (!isTrue(this.settings.layers.enable_layers) || parseInt(this.settings.spots[i].layerID, 10) === parseInt(this.settings.runtime.layerID, 10)) {
                ...
                if (!isTrue(e.static)) {
                    ...
                    if ("spot" === e.type) {
                        ...
                        var h = e.x / 100 * this.wrap.width() - a / 2, r = e.y / 100 * this.wrap.height() - o / 2, p = a, l = o;
            ...
            for (var i = 0; i < this.openedTooltips.length; i++) {
                var e = this.getEventCoordinates(t), s = this.tooltipsContainer.find('.imp-tooltip[data-index="' + this.openedTooltips[i] + '"]'), n = this.openedTooltips[i];
                ...
                var o = s.outerWidth(), h = s.outerHeight(), r = s.offset().left - this.wrap.offset().left, p = s.offset().top - this.wrap.offset().top;
                r = r / this.wrap.width() * 100, p = p / this.wrap.height() * 100, o = o / this.wrap.width() * 100, h = h / this.wrap.height() * 100;
                var l = [];
                if ("left" === this.settings.spots[n].tooltip_style.position)l = [[r, p], [r + o, p], [r + o + (a = a / this.wrap.width() * 100), p + h - h / 3 - h / 3], [r + o + a, p + h - h / 3], [r + o, p + h], [r, p + h]];
                if ("right" === this.settings.spots[n].tooltip_style.position)l = [[r, p], [r + o, p], [r + o, p + h], [r, p + h], [r - (a = a / this.wrap.width() * 100), p + h - h / 3], [r - a, p + h - h / 3 - h / 3]];
                if ("top" === this.settings.spots[n].tooltip_style.position)l = [[r, p], [r + o, p], [r + o, p + h], [r + o - o / 3, p + h + (a = a / this.wrap.height() * 100)], [r + o - o / 3 - o / 3, p + h + a], [r, p + h]];
                if ("bottom" === this.settings.spots[n].tooltip_style.position)l = [[r, p], [r + o - o / 3 - o / 3, p - (a = a / this.wrap.height() * 100)], [r + o - o / 3, p - a], [r + o, p], [r + o, p + h], [r, p + h]];
            ...
            if ("spot" === e.type) {
                ...
                if (!isTrue(e.default_style.use_icon)) {
                    var o = hexToRgb(t.background_color) || {r: 0, b: 0, g: 0}, h = hexToRgb(t.border_color) || {
                            r: 0,
                            b: 0,
                            g: 0
                        };
            ...
            if ("poly" === e.type || "path" === e.type) {
                var g = hexToRgb(t.background_color) || {r: 0, b: 0, g: 0}, d = hexToRgb(t.stroke_color) || {
                        r: 0,
                        b: 0,
                        g: 0
                    };
            ...
            var s = (this.wrapWidth * this.targetZoom - this.wrapWidth * this.zoom) / 2, n = (this.wrapHeight * this.targetZoom - this.wrapHeight * this.zoom) / 2;
            if (i && e) {
                var a = i - this.zoomWrap.offset().left, o = e - this.zoomWrap.offset().top, h = s * ((this.wrapWidth * this.zoom / 2 - a) / (this.wrapWidth * this.zoom / 2)), r = n * ((this.wrapHeight * this.zoom / 2 - o) / (this.wrapHeight * this.zoom / 2));
            ...
            var i = (t.originalEvent.touches[0].pageX + t.originalEvent.touches[1].pageX) / 2, e = (t.originalEvent.touches[0].pageY + t.originalEvent.touches[1].pageY) / 2;
            this.actualPanX += i - this.lastX, this.actualPanY += e - this.lastY;
            var s = this.wrap.width(), n = this.wrap.height(), a = this.wrap.offset().left, o = this.wrap.offset().top, h = window.innerWidth, r = window.innerHeight;
            ...
            if (t ? (this.zoom = lerp(this.zoom, this.targetZoom, .1), this.actualPanX = lerp(this.actualPanX, this.targetPanX, .1), this.actualPanY = lerp(this.actualPanY, this.targetPanY, .1), Math.abs(this.zoom - this.targetZoom) < .001 && (this.zoom = this.targetZoom), Math.abs(this.actualPanX - this.targetPanX) < 1 && (this.actualPanX = this.targetPanX), Math.abs(this.actualPanY - this.targetPanY) < 1 && (this.actualPanY = this.targetPanY)) : (this.zoom = this.targetZoom, this.actualPanX = this.targetPanX, this.actualPanY = this.targetPanY), this.zoomWrap.css({transform: "scale(" + this.zoom + ", " + this.zoom + ")"}), this.translateWrap.css({transform: "translate(" + this.actualPanX + "px, " + this.actualPanY + "px)"}), isTrue(this.settings.zooming.enable_navigator) && isTrue(this.settings.zooming.enable_zooming)) {
                var i = -this.actualPanX * this.navigatorRatio / this.zoom + this.navigatorMarginX / this.zoom, e = this.wrapWidth * this.navigatorRatio - (i + this.uiNavigatorWindowWidth / this.zoom), s = -this.actualPanY * this.navigatorRatio / this.zoom + this.navigatorMarginY / this.zoom, n = this.wrapHeight * this.navigatorRatio - (s + this.uiNavigatorWindowHeight / this.zoom);
            ...
            s && 0 < s.length ? (this.shapesMenuWrap.addClass("imp-searching"), $(".imp-shapes-menu-shape-title").each(function () {
                var t = new RegExp("(" + s + ")", "gi"), i = $(this).data("imp-content"), e = $(this).data("imp-content").replace(t, '<span class="imp-search-highlight">$&</span>');
    ...
    function i(t) {
        var i = t || window.event, e = v.call(arguments, 1), s = 0, n = 0, a = 0, o = 0, h = 0, r = 0;
    ...
    var m, f, t = ["wheel", "mousewheel", "DOMMouseScroll", "MozMousePixelScroll"], e = "onwheel" in document || 9 <= document.documentMode ? ["wheel"] : ["mousewheel", "DomMouseScroll", "MozMousePixelScroll"], v = Array.prototype.slice;
    ...
    var y = d.event.special.mousewheel = {
        version: "3.1.12", setup: function () {
            ...
            var i = d(t), e = i["offsetParent" in d.fn ? "offsetParent" : "parent"]();
